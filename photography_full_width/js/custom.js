(function(){
  ...
  "use strict"
	...
	// backstretch image carousel for header section

	$(".headerCarousel").backstretch([
	  ...
	  $('#next').click(function(x) {
	    x.preventDefault();
	    $('.headerCarousel').data('backstretch').next();
	  });
	  $('#prev').click(function(x) {
	    x.preventDefault();
	    $('.headerCarousel').data('backstretch').prev();
  	});
